...
function draw_gauge_ring(display, data, value)
    ...
    cairo_select_font_face (display, "Caviar Dreams", CAIRO_FONT_SLANT_NORMAL, txt_weight)
    ...
    cairo_select_font_face (display, "Caviar Dreams", CAIRO_FONT_SLANT_NORMAL, caption_weight);
